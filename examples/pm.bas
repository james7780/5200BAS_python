...
Z=0
FOR Z TO $17
    POKE $1800+Y,$FF						';Bar 4 pixels wide of color 3
    Y = Y + 2
    POKE $1800+Y,$55						';Bar 4 pixels wide of color 1
    Y = Y + 2
    POKE $1800+Y,$AA						';Bar 4 pixels wide of color 2
    Y = Y + 6
NEXT Z
...
POKE sDMACTL,$3A				' Enable display list DMA + 2 line sprites resolution + normal width background
